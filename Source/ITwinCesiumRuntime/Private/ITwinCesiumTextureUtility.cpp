 ...
 */
class FITwinCesiumTextureData : public FResourceBulkDataInterface {
public:
  FITwinCesiumTextureData(const CesiumGltf::ImageCesium& image)
 ...
 *
 */
class FITwinCesiumTextureResource : public FTextureResource {
public:
  ...
  virtual ~FITwinCesiumTextureResource() {
...
FName FITwinCesiumTextureResource::TextureGroupStatFNames[TEXTUREGROUP_MAX] = {
...
UTexture2D* loadTextureGameThreadPart(LoadedTextureResult* pHalfLoadedTexture) {
  ...
  FITwinCesiumTextureResource* pCesiumTextureResource = new FITwinCesiumTextureResource(
      pTexture,
