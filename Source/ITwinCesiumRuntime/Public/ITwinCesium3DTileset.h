...
#include "ITwinCesiumCreditSystem.h"
...
#include <vector>
#include "ITwinCesium3DTileset.generated.h"
...
DECLARE_MULTICAST_DELEGATE_OneParam(
    FITwinCesium3DTilesetLoadFailure,
    const FITwinCesium3DTilesetLoadFailureDetails&);
...
private:
  ...
  TSoftObjectPtr<AITwinCesiumGeoreference> Georeference;
  ...
  UPROPERTY(
      ...
      Category = "Cesium",
      Meta = (AllowPrivateAccess))
  AITwinCesiumGeoreference* ResolvedGeoreference = nullptr;

public:
  /** @copydoc AITwinCesium3DTileset::Georeference */
  UFUNCTION(BlueprintCallable, Category = "Cesium")
  TSoftObjectPtr<AITwinCesiumGeoreference> GetGeoreference() const;

  /** @copydoc AITwinCesium3DTileset::Georeference */
  UFUNCTION(BlueprintCallable, Category = "Cesium")
  void SetGeoreference(TSoftObjectPtr<AITwinCesiumGeoreference> NewGeoreference);
   ...
   */
  UFUNCTION(BlueprintCallable, Category = "Cesium")
  AITwinCesiumGeoreference* ResolveGeoreference();
...
private:
  ...
  UPROPERTY(
      ...
      Category = "Cesium",
      Meta = (AllowPrivateAccess))
  TSoftObjectPtr<AITwinCesiumCreditSystem> CreditSystem;
  ...
  UPROPERTY(
      ...
      Category = "Cesium",
      Meta = (AllowPrivateAccess))
  AITwinCesiumCreditSystem* ResolvedCreditSystem = nullptr;
  ...
  UPROPERTY(
      ...
      Category = "Cesium",
      Meta = (AllowPrivateAccess))
  TSoftObjectPtr<AITwinCesiumCameraManager> CameraManager;
  ...
  UPROPERTY(
      ...
      Category = "Cesium",
      Meta = (AllowPrivateAccess))
  AITwinCesiumCameraManager* ResolvedCameraManager = nullptr;
  ...
  UPROPERTY(
      ...
      Category = "Cesium",
      Meta = (AllowPrivateAccess))
  UITwinCesiumBoundingVolumePoolComponent* BoundingVolumePoolComponent = nullptr;
...
public:
  /** @copydoc AITwinCesium3DTileset::CreditSystem */
  UFUNCTION(BlueprintCallable, Category = "Cesium")
  TSoftObjectPtr<AITwinCesiumCreditSystem> GetCreditSystem() const;

  /** @copydoc AITwinCesium3DTileset::CreditSystem */
  UFUNCTION(BlueprintCallable, Category = "Cesium")
  void SetCreditSystem(TSoftObjectPtr<AITwinCesiumCreditSystem> NewCreditSystem);
   ...
   */
  UFUNCTION(BlueprintCallable, Category = "Cesium")
  AITwinCesiumCreditSystem* ResolveCreditSystem();
  ...
  void SetCameraManager(TSoftObjectPtr<AITwinCesiumCameraManager> NewCameraManager);
   ...
   */
  UFUNCTION(BlueprintCallable, Category = "Cesium")
  AITwinCesiumCameraManager* ResolveCameraManager();
  ...
  // This mirrors
  // UITwinCesiumRuntimeSettings::EnableExperimentalOcclusionCullingFeature so that
...
public:
  ...
  UFUNCTION(BlueprintGetter, Category = "Cesium")
  UITwinCesiumIonServer* GetCesiumIonServer() const { return CesiumIonServer; }

  UFUNCTION(BlueprintSetter, Category = "Cesium")
  void SetCesiumIonServer(UITwinCesiumIonServer* Server);
  ...
  FITwinCustomDepthParameters GetCustomDepthParameters() const {
    return CustomDepthParameters;
  }

  UFUNCTION(BlueprintSetter, Category = "Rendering")
  void SetCustomDepthParameters(FITwinCustomDepthParameters InCustomDepthParameters);

  UFUNCTION(BlueprintGetter, Category = "Cesium|Rendering")
  FITwinCesiumPointCloudShading GetPointCloudShading() const {
    return PointCloudShading;
  }

  UFUNCTION(BlueprintSetter, Category = "Cesium|Rendering")
  void SetPointCloudShading(FITwinCesiumPointCloudShading InPointCloudShading);
...
private:
  ...
  std::vector<FITwinCesiumCamera> GetCameras() const;
  std::vector<FITwinCesiumCamera> GetPlayerCameras() const;
  std::vector<FITwinCesiumCamera> GetSceneCaptures() const;
...
#if WITH_EDITOR
  std::vector<FITwinCesiumCamera> GetEditorCameras() const;
...
private:
  ...
  std::optional<FITwinCesiumFeaturesMetadataDescription>
  ...
  friend class UITwinCesiumGltfPointsComponent;
};
