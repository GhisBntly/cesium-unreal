...
#include "ITwinCesiumMetadataValue.generated.h"

/**
 * A Blueprint-accessible wrapper for a glTF metadata value.
 */
USTRUCT(BlueprintType)
struct ITWINCESIUMRUNTIME_API FITwinCesiumMetadataValue {
...
public:
   ...
   */
  FITwinCesiumMetadataValue() : _value(std::monostate{}), _valueType() {}
   ...
   */
  template <typename T>
  explicit FITwinCesiumMetadataValue(const std::optional<T>& MaybeValue)
...
UCLASS()
class ITWINCESIUMRUNTIME_API UITwinCesiumMetadataValueBlueprintLibrary
...
public:
  ...
  UFUNCTION(
      ...
      BlueprintPure,
      Category = "Cesium|Metadata|Value")
  static FITwinCesiumMetadataValueType
  GetValueType(UPARAM(ref) const FITwinCesiumMetadataValue& Value);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|Value")
  static bool
  GetBoolean(UPARAM(ref) const FITwinCesiumMetadataValue& value, bool DefaultValue);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|Value")
  static uint8
  GetByte(UPARAM(ref) const FITwinCesiumMetadataValue& Value, uint8 DefaultValue);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|Value")
  static int32
  GetInteger(UPARAM(ref) const FITwinCesiumMetadataValue& Value, int32 DefaultValue);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|Value")
  static float
  GetFloat(UPARAM(ref) const FITwinCesiumMetadataValue& Value, float DefaultValue);
  ...
  /**
   * Attempts to retrieve the value as a FITwinCesiumPropertyArray. If the property
   * is not an array type, this returns an empty array.
   *
   * @return The value as a FITwinCesiumPropertyArray.
   */
  UFUNCTION(
      BlueprintCallable,
      BlueprintPure,
      Category = "Cesium|Metadata|Value")
  static FITwinCesiumPropertyArray GetArray(UPARAM(ref)
  ...
  UFUNCTION(
      ...
      BlueprintPure,
      Category = "Cesium|Metadata|Value")
  static bool IsEmpty(UPARAM(ref) const FITwinCesiumMetadataValue& Value);
