...
#include "ITwinCesiumMetadataPickingBlueprintLibrary.generated.h"
...
UCLASS()
class ITWINCESIUMRUNTIME_API UITwinCesiumMetadataPickingBlueprintLibrary
...
public:
  ...
  UFUNCTION(
      ...
      BlueprintPure,
      Category = "Cesium|Metadata|Picking")
  static TMap<FString, FITwinCesiumMetadataValue> GetPropertyTableValuesFromHit(
      const FHitResult& Hit,
  ...
  UFUNCTION(
      ...
      BlueprintPure,
      Category = "Cesium|Metadata|Picking")
  static TMap<FString, FITwinCesiumMetadataValue> GetPropertyTextureValuesFromHit(
      const FHitResult& Hit,
  ...
  static TMap<FString, FITwinCesiumMetadataValue> GetMetadataValuesForFace(
